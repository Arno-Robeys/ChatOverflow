        ...
        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" action="#">
                <div>
                    ...
                    <input type="text" name="firstname" id="firstname" className="border sm:text-sm rounded-lg block w-full p-2.5" placeholder="Bert" />
                </div>
                <div>
                    <label htmlFor="lastname" className="block mb-2 text-sm font-medium ">Your lastname</label>
                    <input type="text" name="lastname" id="lastname" className="border sm:text-sm rounded-lg block w-full p-2.5" placeholder="Vandenbroek" />
                </div>
                <div>
