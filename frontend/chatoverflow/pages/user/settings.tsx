          ...
          <p className="mt-1 text-sm leading-6 text-gray-600  dark:bg-gray-800  dark:text-gray-300">
              ...
              <Disclosure>
                {({ open }) => (
                  <>
                    ...
                    <Disclosure.Button  className="mt-2 rounded-md bg-white px-2.5 py-1.5 text-sm font-semibold text-gray-900 shadow-sm dark:bg-indigo-600 dark:font-semibold dark:text-white dark:shadow-sm dark:hover:bg-indigo-500 dark:focus-visible:outline dark:focus-visible:outline-2 dark:focus-visible:outline-offset-2 dark:focus-visible:outline-indigo-600"> 
                  {open ? (
                    <>
                      ...
                      <Transition as={Fragment}
                        ...
                        <Disclosure.Panel className="rounded-md bg-white dark:bg-indigo-600 py-1 shadow-lg ring-1 ring-black ring-opacity-5 mt-2">
            ...
            <div className="mt-10 flex flex-col sm:flex-row sm:justify-between">
                    <div className="mb-4 sm:mb-0 sm:w-1/2 sm:pr-2">
                        ...
                        <input type="text" defaultValue={user?.firstname} ref={inputRefs[0]} name="firstname" id="firstname" className="block w-full rounded-md border-0 py-1.5 text-gray-900 dark:text-gray-300 dark:bg-gray-800 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
                    </div>
                    <div className="sm:w-1/2 sm:pl-2">
                        ...
                        <input type="text" defaultValue={user?.lastname} ref={inputRefs[1]} name="lastname" id="lastname" className="block w-full rounded-md border-0 py-1.5 text-gray-900  dark:text-gray-300 dark:bg-gray-800 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 placeholder:dark:text-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
                    </div>
            </div>
            <div className="mt-4">
                <label htmlFor="nickname" className="block text-sm font-medium leading-6 text-gray-900  dark:text-gray-300">Nickname</label>
                <input type="text" defaultValue={user?.nickname || ""} ref={inputRefs[2]} name="nickname" id="nickname" className="block w-full rounded-md border-0 py-1.5 text-gray-900 dark:text-gray-300 dark:bg-gray-800 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
            </div>
            <div className="mt-4">
                ...
                <textarea name="description" defaultValue={user?.profile.description || ""} ref={descriptionRef} id="description" placeholder="Write a few sentences about yourself" className="block w-full h-36 sm:h-24 rounded-md border-0 text-gray-900 dark:text-gray-300 dark:bg-gray-800 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:py-1.5 sm:text-sm sm:leading-6"/>
            </div>

            <div className="mt-4">
                <label htmlFor="hobby" className="block text-sm font-medium leading-6 text-gray-900  dark:text-gray-300">Hobby</label>
                <input type="text" defaultValue={user?.profile.hobby || ""} ref={inputRefs[3]} name="hobby" id="hobby" className="block w-full rounded-md border-0 py-1.5 text-gray-900 dark:text-gray-300 dark:bg-gray-800 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
            </div>
            <div className="mt-4 flex flex-col sm:flex-row sm:justify-between">
                    <div className="mb-4 sm:mb-0 sm:w-1/2 sm:pr-2">
                        ...
                        <input type="text" defaultValue={user?.profile.education || ""} ref={inputRefs[4]} name="education" id="education" className="block w-full rounded-md border-0 py-1.5 text-gray-900 dark:text-gray-300 dark:bg-gray-800 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
                    </div>
                    <div className="sm:w-1/2 sm:pl-2">
                        <label htmlFor="work" className="block text-sm font-medium leading-6 text-gray-900  dark:text-gray-300">Work</label>
                        <input type="text" defaultValue={user?.profile.work || ""} ref={inputRefs[5]} name="work" id="work" className="block w-full rounded-md border-0 py-1.5 text-gray-900 dark:text-gray-300 dark:bg-gray-800 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
                    </div>
            </div>

            <div className="mt-4">
                <label htmlFor="tags" className="block text-sm font-medium leading-6 text-gray-900  dark:text-gray-300 dark:bg-gray-800">Tags</label>
                <ReactTags tags={tags} autofocus={false} delimiters={[188, 13]} handleDelete={handleDelete} handleAddition={handleAddition} inputFieldPosition="top" maxLength={30} classNames={{tagInputField: 'block w-full rounded-md border-0 py-1.5 text-gray-900 dark:text-gray-300 dark:bg-gray-800 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 sm:text-sm sm:leading-6 focus:ring-indigo-600', tag: "mr-1.5 p-1 rounded-md bg-gray-200 text-gray-900 dark:text-gray-300 dark:bg-gray-600 dark:ring-indigo-600", selected: "mt-3"}}/>
            </div>
        </div>

      <div className="mt-6 flex items-center justify-end gap-x-6">
        <Link className="text-sm font-semibold leading-6 text-gray-900  dark:text-gray-300 dark:bg-gray-800" href={'/user'}>
          Cancel
        </Link>
